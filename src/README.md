...
* Размер занятого пространства - 2695812.
* Размер свободного пространства - 5263924.
* Процент использования - 34%.
* По умолчанию утилита df выводит на экран информацию в байтах. Существует опция -h для вывода размеров в кратных величинах.
* ![](./screenshots/img_11.1.png)
* Размер раздела - 8.1G.
...
* ![](./screenshots/img_14.1.png)
* Перезапуск службу SSHd.
* ![](./screenshots/img_14.2.png)

## Part 15. Использование планировщика заданий CRON
* Командой crontab -e создаём файл с расписанием задач.
* Строчки о выполнении в системном журнале.
* ![](./screenshots/img_15.1.png)
* Список текущих задач CRON.
* ![](./screenshots/img_15.2.png)
* Удаление файла задач и проверка, что никаких задач не запланировано.
* ![](./screenshots/img_15.3.png)